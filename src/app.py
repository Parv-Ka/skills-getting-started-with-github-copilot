...
activities = {
    ...
    "Swimming Club": {
        ...
        "max_participants": 18,
        "participants": ["lena@mergington.edu", "mark@mergington.edu"]
    },
    "Art Studio": {
        "description": "Explore painting, drawing, and mixed media projects",
        "schedule": "Wednesdays, 3:30 PM - 5:00 PM",
        "max_participants": 16,
        "participants": ["zoe@mergington.edu", "maria@mergington.edu"]
    },
    "Drama Club": {
        "description": "Practice acting, stage design, and put on school performances",
        "schedule": "Thursdays, 3:30 PM - 5:00 PM",
        "max_participants": 20,
        "participants": ["lucas@mergington.edu", "emma@mergington.edu"]
    },
    "Debate Team": {
        "description": "Build public speaking and argumentation skills through competitions",
        "schedule": "Mondays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 14,
        "participants": ["sophia@mergington.edu", "ryan@mergington.edu"]
    },
    "Math Olympiad": {
        "description": "Solve challenging math problems and prepare for academic contests",
        "schedule": "Tuesdays, 4:00 PM - 5:30 PM",
        "max_participants": 15,
        "participants": ["julia@mergington.edu", "kevin@mergington.edu"]
    }
}
